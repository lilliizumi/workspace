...
* I've started you off, replace the sec
*/
...
function question3(){
 	$(".false-fact").html("True Fact");
}

$("#button-3").click(question3);
...
function question8(){
	$(".city").attr("src", "http://lorempixel.com/g/500/400/food");
//modifies the src attribute of any/all elements with class of city to specified url
}

$("#button-3").click(question8);
